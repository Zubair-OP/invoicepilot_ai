...
const desktopFeatures = [
  {
    icon: Gift,
    title: "100% Free Starter Plan",
    desc: "Generate professional invoices right away — no credit card needed",
  },
  {
    icon: Zap,
    title: "Instant AI Invoicing",
    desc: "Convert simple natural language prompts into GST PDF invoices",
  },
  {
    icon: Shield,
    title: "Full GST Compliance",
    desc: "Automatic CGST, SGST & IGST breakdown with HSN/SAC code mapping",
  },
];
        ...
        <div className="auth-brand-inner">
          ...
          <div className="auth-brand-copy">
            ...
            <h1 className="auth-brand-headline">
              ...
              <span className="auth-text-gradient">invoices with AI.</span>
            </h1>
            <p className="auth-brand-sub">
              Join 10,000+ freelancers, consultants, and companies sending
              pixel-perfect GST invoices and getting paid faster.
            </p>
          </div>
          ...
          <div className="auth-mock-card">
            <div className="auth-mock-header">
              <div className="auth-mock-prompt-pill">
                <Sparkles size={13} className="text-emerald-400" />
                <span>&quot;Bill Acme $18,888 for UI/UX Design with GST&quot;</span>
              </div>
            </div>
            <div className="auth-mock-body">
              <div className="auth-mock-result">
                <span className="auth-mock-label">Instant Result</span>
                <span className="auth-mock-amount">$18,888 Total (with GST)</span>
              </div>
              <span className="auth-mock-status">
                <Check size={12} strokeWidth={3} /> Ready to Send
              </span>
            </div>
          </div>
            ...
            localization={{
              signUp: {
                start: {
                  ...
                  subtitle: "Welcome to InvoicePilot! Fill in your details to get started.",
                },
              },
            }}
            appearance={{
