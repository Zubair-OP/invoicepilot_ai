...
const features = [
  ...
  { icon: CheckCircle, text: "Join 10,000+ freelancers & businesses" },
];
        ...
        <div className="auth-brand-inner">
          ...
          <div className="auth-brand-copy">
            <h1 className="auth-brand-headline">
              Start invoicing smarter<br />today — for free.
            </h1>
            <p className="auth-brand-sub">
              Set up your account in under 60 seconds and send your first
              professional invoice right away.
            </p>
          </div>
